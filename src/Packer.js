...
function pack(columns: any[], width: number, calculatedEvents: CalculatedEventDimens[]) {
...
function populateEvents(events: StartEndEvent[], screenWidth: number): CalculatedEventDimens[] {
