...
export default class EventCalendar extends React.Component {
  ...
  _renderItem({ index, item }) {
    const { width, format24h, initDate, scrollToFirst,onDateChange } = this.props
        ...
        <View style={this.styles.header}>
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              this.props.onDateChange(moment(this.props._goToPage).add(this.state.index - this.props.size - 1, 'days'))
            }}>
